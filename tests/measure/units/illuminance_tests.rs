...
// =============================================================================
//! Exact definitions and contract tests for the illuminance unit family.
...
#[test]
fn test_illuminance_unit_contract() {
    assert_unit_family_valid::<unit::Illuminance>();
    assert_unit_contract::<unit::Illuminance>();
}

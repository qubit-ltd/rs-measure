...
// =============================================================================
//! Exact definitions and contract tests for the molar mass unit family.
...
#[test]
fn test_molar_mass_unit_contract() {
    assert_unit_family_valid::<unit::MolarMass>();
    assert_unit_contract::<unit::MolarMass>();
}
